...
// ضبط الترميز UTF-8 للاتصال
$conn->set_charset("utf8mb4");

$today = date("Y-m-d");
// جلب الحجوزات المستقبلية لقسم البديكير فقط
...
<head>
  <meta charset="UTF-8">
  <title>حجوزات قسم البديكير - Top Sisters</title>
  <style>
    ...
    a.archive-link {font-size:16px; background:linear-gradient(90deg,#ff69b4,#ffc0cb); color:white; padding:8px 15px; border-radius:8px; text-decoration:none; box-shadow:0 0 12px rgba(255,105,180,0.6); transition:0.3s;}
    a.archive-link:hover {background:linear-gradient(90deg,#ff1493,#ff69b4); box-shadow:0 0 18px rgba(255,105,180,0.8); transform:scale(1.05);}
    ...
    .soon {background-color:#ffe4e9; font-weight:bold;}
    img {border-radius:8px; box-shadow:0 0 10px rgba(255,105,180,0.5);}
  </style>
</head>
<body>
  <h2>🦶 حجوزات قسم البديكير</h2>
  <h2><a href="pedicure_archive.php" class="archive-link">عرض الأرشيف</a></h2>
